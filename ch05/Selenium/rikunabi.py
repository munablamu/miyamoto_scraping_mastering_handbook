"""
リクナビNEXTから「Django」で検索したデータを取得する
"""
import time
import pandas as pd
...
def update_page_num(driver: WebDriver) -> None:
...
def get_normal_info(driver: WebDriver) -> dict:
...
def get_rcn_info(driver: WebDriver) -> dict:
